...
include 'koneksi.php'; 
	...
	if($_SESSION['status']!="login"){
		header("location:Pages.Auth.Login.Petugas.php?pesan=belum_login");
	}
?>
        ...
        <div class="navbar-right">
            ...
            <div class="user d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right mt-3">
                    ...
                    <a class="dropdown-item" href="cek.logout.php">Keluar</a>
                </div>
            </div>
        </div>
    </nav>
                            ...
                            <div class="glide__track" data-glide-el="track">
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        <a href="Pages.Data.List.php" class="card">
                                    ...
                                    <li class="glide__slide">
                                        <a href="Pages.Belum.Lunas.php" class="card">
                                            <div class="card-body text-center">
                                    ...
                                    <li class="glide__slide">
                                        <a href="Pages.Lunas.php" class="card">
                                            <div class="card-body text-center">
                                    ...
                                    <li class="glide__slide">
                                        <a href="Pemasukkan.Hari.Ini.php" class="card">
                                            <div class="card-body text-center">
