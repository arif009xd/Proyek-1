...
require 'koneksi.php';
    ...
    $query = "SELECT * FROM data_transaksi WHERE No = '$id'";
...
{
    // var_dump($_POST["waktu_pembayaran"]);
    // die;     
 $nama =$_POST["nama"];
 $nis =$_POST["nis"];
 $kelas =$_POST["kelas"];
...
$sql="UPDATE data_transaksi SET nama = '$nama', nis = '$nis', kelas = '$kelas', waktu_pembayaran = '$waktu_pembayaran', bulan_bayar = '$bulan_bayar', jumlah_bayar = '$jumlah_bayar', status = '$status' WHERE no = '$id'";
    ...
    <main>
        <div class="container-fluid disable-text-selection">
            <div class="row">
                <div class="col-12">
                    <div class="mb-3">
                        <h1>Form Edit Data Transaksi Pembayaran</h1>
            ...
            <div class="card-content">
                        <form class="form-horizontal" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-1" name="nama" value='<?php echo $data["nama"];?>'>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-type-2" class="col-sm-3 control-label">Nis</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-2"name="nis" value='<?php echo $data["nis"];?>' >
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-type-2" class="col-sm-3 control-label">Kelas</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-2" name="kelas" value='<?php echo $data["kelas"];?>' >
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-type-2" class="col-sm-3 control-label">Waktu Pembayaran</label>
                                <div class="col-sm-9">
                                <input name="waktu_pembayaran" type="date" class="form-control" id="inp-type-2" value='<?php echo $data["waktu_pembayaran"];?>'>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-type-2" class="col-sm-3 control-label">Bulan Bayar</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-2" name="bulan_bayar" value='<?php echo $data["bulan_bayar"];?>'>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inp-type-2" class="col-sm-3 control-label">Jumlah Bayar</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-2" name="jumlah_bayar" value='<?php echo $data["jumlah_bayar"];?>'>
                                </div>
                            </div>
                            <div class="form-group">
