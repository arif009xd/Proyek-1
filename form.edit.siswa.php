                            ...
                            <ul class="list-unstyled inner-level-menu">
                                ...
                                <li>
                                    <a href="Pages.Product.Images.php">
                                        <i class="simple-icon-people"></i> <span class="d-inline-block">User Account</span>
                                    </a>
                                </li>
                                <li>
            ...
            <div class="card-content">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="inp-type-2" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-lg top-right-button mr-1">Submit</button>
                            </div>
